...
iso_publisher="Obscurix <https://obscurix.github.io>"
iso_application="Obscurix Live CD"
iso_version="0.2"
install_dir=arch
work_dir=work
out_dir=out
...
make_basefs() {
    ...
    mkarchiso ${verbose} -w "${work_dir}/x86_64" -C "${work_dir}/pacman.conf" -D "${install_dir}" -p "haveged intel-ucode amd-ucode memtest86+ efitools" install
}
